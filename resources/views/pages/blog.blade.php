...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index"><span>Com</span>pany</a></h1>
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <a href="blog-single">Dolorum optio tempore voluptas dignissimos cumque fuga qui quibusdam quia reiciendis</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single">John Doe</a></li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single"><time datetime="2020-01-01">Jan 1, 2020</time></a></li>
                  <li class="d-flex align-items-center"><i class="icofont-comment"></i> <a href="blog-single">12 Comments</a></li>
                </ul>
              </div>
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <a href="blog-single">Non rem rerum nam cum quo minus. Dolor distinctio deleniti explicabo eius exercitationem. Veniam eius velit ab ipsa quidem rem.</a>
              </h2>
